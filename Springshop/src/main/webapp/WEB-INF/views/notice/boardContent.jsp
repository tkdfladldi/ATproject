	...
	<body class="bg-primary">
		...
		<form action="/boardContent" method="post">
			<div _ngcontent-rgv-c1="" class="card-header">
				<input class="form-control" id="title" name="title" type="text" placeholder="게시글 제목.." />
			</div>
			
			<div _ngcontent-rgv-c1="" class="card-body" style="height: 650px;">
					<textarea class="form-control" rows="23" name="content" id="content" placeholder="내용을 입력해 주세요.." ></textarea>
			</div>
			<div _ngcontent-rgv-c1="" class="card-footer small text-muted">
				<button type="submit" id="submit" class="btn btn-primary">글쓰기</button></div>
		</form>
		</div>
		</sb-card>
		</div>
