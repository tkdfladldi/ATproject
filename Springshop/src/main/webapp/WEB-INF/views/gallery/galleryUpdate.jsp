                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5" style="top: 60px;">
                                    ...
                                    <div class="card-header">
                                    		<input style="height: 70px; width: 500px;"id="title" name="title" value="${gallery.title}"/></div>
                                    
                                    <div class="card-body">
                                    		<input type="hidden" name="fileName" value="${gallery.fileName}">
                                       		<input type="hidden" name="gid" value="${gallery.gid}">
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" style="height: 250px;" rows="23" name="content" id="content" >${gallery.content}</textarea>
                                             
                                            </div>
                                           
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            	
                                          변경<input type="file" id="file" name="file"  />
                                          
                                              	 <span >현재 파일 ${gallery.fileName}</span>
...
<c:if test="${member == null}">
	<h2>로그인이 필요합니다.</h2>
     ...
     <img style="position: relative;height: 451px; width : 380px; bottom: 645px; left: 117px;" src="/resources/file/${gallery.fileName}"/>
    </body>
