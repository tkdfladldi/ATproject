     	...
     	<script>
          	 ...
          	 $(document).ready(function(){
         		$("#submit").on("click", function(){
         			...
         			//세션 비밀번호와 입력한 비밀번호와 비교, 입력한 비밀번와 비밀번호 확인 비교
         			var Password = $("#userPw").val();
         			var Password2 = $("#userPw2").val();
         			
         			if(Password !== Password2 || '${member.userPw}' !== Password || '${member.userPw}' !== Password2){
         				alert("비밀번호가 맞지않습니다.");
         				return false;
         			}
         		});
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">회원탈퇴</h3></div>
                                    <div class="card-body">
                                    
                                       <form action="/memberDelete" method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="userPw"  name="userPw" type="password" placeholder="ID" />
                                                <label for="inputEmail">비밀번호</label>
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="userPw2" name="userPw2"  type="password" placeholder="Password" />
