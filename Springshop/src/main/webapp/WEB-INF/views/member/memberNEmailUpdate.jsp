                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">이름 및 이메일 변경</h3></div>
                                    <div class="card-body">
                                    
                                       <form action="memberNEmailUpdate" method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="userPw" type="password" placeholder="Password" />
                                                <label for="inputEmail">현재 비밀번호 입력</label>
                                            </div>
                                            
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="updateName" name="userName" type="text" placeholder="Password" />
                                                <label for="inputPassword">이름 입력</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="updateEmail" name="userEmail"  type="email" placeholder="Password" />
                                                <label for="inputPassword">이메일 입력</label>
                                            </div>
